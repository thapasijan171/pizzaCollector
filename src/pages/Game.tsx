...
export const Game = ({ userProfile, setUserProfile }: UserProfileProps) => {
  ...
  // Function to handle clicking on the IceBom
  const handleClick = () => {
    // Play click sound
  ...
  const handleShareClick = async () => {
    ...
    try {
      await navigator.share({
        title: "IceCollector",
        text: "Simple yet addictive clicker game where you can earn points by clicking on a IcePom. You can use your points to upgrade your clicking power and unlock achievements.",
